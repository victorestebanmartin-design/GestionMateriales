...
def main():
    ...
    print("=" * 60)
    print()
    print("  ANTES de enviar bajas desde el panel admin:")
    print("    1. Abre el Excel con las macros habilitadas")
    print("    2. NO ejecutes la macro manualmente (el agente la lanza el solo)")
    print("       Si la ejecutas tu primero, el agente se confundira")
    print("    3. Deja Excel abierto en segundo plano y no lo toques")
    print()
